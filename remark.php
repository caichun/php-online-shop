...
$sql=mysql_query("select * from remark where u_id='".$_SESSION['user_id']."'");
$num=mysql_num_rows($sql);
if(!$num){
    echo "<script>alert('您还没有评论!');history.go(-1);</script>";
     exit;
}
?>
<!DOCTYPE HTML>
...
<div class="container_12">
  <div class="grid_12">
    <div class="breadcrumbs"> <a href="index.php">首页</a><span>&#8250;</span><span class="current">评论</span> </div>
    <!-- .breadcrumbs --> 
  </div>
  <!-- .grid_12 --> 
</div>
                        ...
                        <table class="favourite">
                            ...
                            for ($i = 0; $i < count($product_id); $i++) {
                                ...
                                <tr>
                                    ...
                                    <td class="name"><?php echo $text[$i];?></td>
                                    ...
                                    <td class="close"><a title="删除" class="close" href="action/remark_delete.php?remark_id=<?php echo $remark_id[$i]; ?>" onclick="if (confirm('确实要删除此条记录吗？'))
                                                return true;
                                            else
                                                return false;
                                                         "></a></td>
