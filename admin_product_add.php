 ...
 <body>
    ...
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="index.php">首页</a><span>&#8250;</span><a href="admin_index.php">管理后台</a><span>&#8250;</span><span class="current">添加商品</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
  ...
  <section id="main">
    <div class="container_12">
	        ...
	        <h3>商品管理</h3>
		     ...
		     <nav class="left_menu">
			    <ul>
				   ...
				   <li class="current"><a href="admin_product_add.php">添加商品</a></li>
       ...
       <div id="content" class="grid_9">
	      <h1 class="page_title">添加商品</h1>

		<div class="product_page">
			<div class="related">
			<form class="add_comments" method="post" enctype="multipart/form-data" action="action/admin_product_add.php">
            ...
            <div class="nickname">
				...
				<input type="text" name="price" class="" value="" />
			</div><!-- .nickname -->
            <div class="clear"></div>
            <div class="nickname">
				<strong>库存</strong><br/>
				<input type="text" name="amount" class="" value="" />
			</div><!-- .nickname -->
                        <div class="clear"></div>
                        <div class="nickname">
				<strong>图片</strong><br/>
				...
				<textarea name="description" cols="50" rows="30"></textarea>
			</div>
                        <div class="clear"></div>
