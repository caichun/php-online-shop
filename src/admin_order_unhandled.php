 ...
 <body>
    ...
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="index.php">首页</a><span>&#8250;</span><a href="admin_index.php">管理后台</a><span>&#8250;</span><span class="current">未处理订单</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
    ...
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
		...
		<div class="product_page">
	      ...
	      <?php
$sql = mysql_query("select * from order_list where o_status='1'");

$num=mysql_num_rows($sql);
if(!$num){
         echo "<script>alert('没有未处理订单!');history.go(-1);</script>";
     exit;
}
...
$status2[$i]="已成交";}	
	...
	?>
          <tr>
		     ...
		     <td class="bg close"><a href="action/admin_order_send.php?order_id=<?php echo $id[$i];?>"><span>发货</span></a><a title="删除" class="close" href="action/admin_order_delete.php?order_id=<?php echo $id[$i];?>" onclick="if(confirm('确实要删除此条记录吗？')) return true;else return false; "></a></td>
	      </tr>
	      <?php 
}?>
