...
//XMLHttpRequest 
	...
	function Ajax(data){	
		xmlhttp.open("GET","action/user_ck.php?username="+document.getElementById("username").value,true);
		xmlhttp.send(null);
...
var process_request = "<img src='images/loading2.gif' width='16' height='16' border='0' align='absmiddle'>正在数据处理中...";
