...
<div class="container_12">
  <div class="grid_12">
    <div class="breadcrumbs"> <a href="index.php">首页</a><span>&#8250;</span><span class="current">注册</span> </div>
    <!-- .breadcrumbs --> 
  </div>
  <!-- .grid_12 --> 
</div>
<!-- .container_12 -->
        ...
        <section id="main" class="entire_width">
            <div class="container_12">      
                <div id="content">
                    <div class="grid_12">
                        <h1 class="page_title">创建一个账户</h1>
                    </div><!-- .grid_12 -->

                    <!-- .grid_6 -->

                    <div class="grid_6">
                        <form class="registed" action="action/signup.php" method="post" name="formUser">
                            <h2>注册用户</h2>
                            ...
                            <div class="email">
                                ...
                                <input type="text" id="username" name="username" onBlur="chkUserName(this)" class="" value="" />
                                <SPAN id="username_notice" >*</SPAN></div><!-- .email -->
                            ...
                            <div class="email">
                                ...
                                <input name="email" id="email" onBlur="checkEmail(this)" type="text" class=""  value="" /><SPAN id=email_notice >*</SPAN>
                            </div><!-- .email -->
                            <div class="email">
                                <strong>手机:</strong><br/>
                                <input name="phone" type="text" class=""  value="" />
                            </div><!-- .email -->
                            ...
                            <div class="submit">										
                                <input type="submit" value="注册" name="Submit1" disabled/>
                            </div><!-- .submit -->
                        </form><!-- .registed -->
                    </div><!-- .grid_6 -->
                </div><!-- #content -->
